...
class AboutController extends Controller
{
   ...
   * Get Banner Data
   */
  private function getBannerData($asset): array
  {
    return [
      'background' => [
   ...
   */
  private function getVisionAndMissionData($asset): array
  {
    return [
      'section' => [
   ...
   * Get Background Data
   */
  private function getBackgroundData($asset): array
  {
    return [
      'section' => [
   ...
   */
  private function getInterventionalData($asset): array
  {
    return [
      'section' => [
  ...
  /**
   * Get Evolutionary Changes Data
   */
  private function getEvolutionaryChangesData($asset): array
  {
    return [
      'section' => [
   ...
   * Get Governance Data
   */
  private function getGovernanceData($asset): array
  {
    return [
      'section' => [
        'title' => 'Governance'
   ...
   * Get Training Data
   */
  private function getTrainingData($asset): array
  {
    return [
      'section' => [
