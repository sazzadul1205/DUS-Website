...
const Playground = ({
  ...
  // Sample publications data (fallback if not provided)
  const samplePublications = [
    {
      ...
      link: "#",
      content: `
        <h2>Understanding Climate Change in Hatiya Island</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Innovative Agricultural Solutions for Coastal Bangladesh</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Powering Island Communities Sustainably</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Protecting the Sundarbans Ecosystem</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Empowering Communities for Disaster Resilience</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Ensuring Water Security in Bangladesh</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Building Sustainable Cities in Bangladesh</h2>
    ...
    },
    {
      ...
      link: "#",
      content: `
        <h2>Transforming Rural Healthcare Delivery</h2>
  ...
  // Use props if available, otherwise use sample data
  ...
  return (
    ...
    >
      ...
      <div className='bg-white min-h-screen'>
        ...
        {/* Related Publications Section (showing only 3 items) */}
        <PublicationsSection
          data={displayPublications}
          isRelated={true}
          ...
          paddingY="py-10 sm:py-15 md:py-20 lg:py-37.5"
          paddingX="px-5 sm:px-8 md:px-12 lg:px-50"
          sectionId="related-publications"
        />
      </div>
