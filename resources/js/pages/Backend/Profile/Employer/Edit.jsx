...
export default function Edit({ user }) {
  ...
  const handleProfileSubmit = (e) => {
    e.preventDefault();
    patch(route('backend.employer.profile.update'), {
      onSuccess: () => {
        Swal.fire({
          icon: 'success',
          title: 'Success!',
  ...
  const handlePasswordSubmit = (e) => {
    e.preventDefault();
    put(route('backend.employer.profile.password.update'), {
      onSuccess: () => {
        resetPassword();
        Swal.fire({
          icon: 'success',
  ...
  const handleCancel = () => {
    router.visit(route('backend.employer.profile.show', { id: user?.id }));
  };
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className={`w-full pl-10 pr-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 ${passwordErrors.password ? 'border-red-500' : 'border-gray-300'
                            }`}
